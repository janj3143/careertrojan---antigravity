...
class AITrainingOrchestrator:
    ...
    def __init__(self, base_path: str):
        ...
        logger.info(f"🤖 AI Training Orchestrator initialized")
    ...
    def load_data(self) -> Dict[str, int]:
        ...
        """
        logger.info("="*80)
        logger.info("📊 LOADING DATA FROM AI_DATA_FINAL")
        logger.info("="*80)
        ...
        if self.profiles_path.exists():
            ...
            logger.info(f"✅ Loaded {stats['candidates']} candidate profiles")
        ...
        if self.companies_path.exists():
            ...
            logger.info(f"✅ Loaded {stats['companies']} companies")
        ...
        if self.job_titles_path.exists():
            ...
            logger.info(f"✅ Loaded {stats['job_titles']} job titles")
    ...
    def prepare_text_data(self) -> Tuple[List[str], List[str]]:
        ...
        """
        logger.info("📝 Preparing text data for training...")
        ...
        logger.info(f"✅ Prepared {len(candidate_texts)} candidate texts")
        logger.info(f"✅ Extracted {len(job_title_texts)} job titles")
    ...
    def train_embeddings(self, texts: List[str], model_name: str = 'all-MiniLM-L6-v2') -> np.ndarray:
        ...
        logger.info(f"🧠 Training Sentence Transformer embeddings ({model_name})...")
        ...
        try:
            ...
            logger.info(f"✅ Created {len(embeddings)} embeddings with {embeddings.shape[1]} dimensions")
    ...
    def train_tfidf(self, texts: List[str], max_features: int = 1000) -> np.ndarray:
        ...
        logger.info(f"📊 Training TF-IDF vectorizer (max_features={max_features})...")
    ...
    def train_job_classifier(self, job_titles: List[str], categories: List[str] = None) -> Dict[str, Any]:
        ...
        logger.info("🎯 Training job title classifier...")
        ...
        try:
            ...
            logger.info(f"✅ Job classifier trained")
    ...
    def run_full_training_pipeline(self) -> Dict[str, Any]:
        ...
        if len(candidate_texts) == 0:
            logger.error("❌ No candidate data available for training")
            return results
