...
class NeuralNetworkTrainer:
    ...
    def __init__(self, base_path: str = None):
        ...
        try:
            ...
            self.models_path = Path(base_path or Path(__file__).parent) / "trained_models" / "neural"
    ...
    def load_training_data(self):
        ...
        logger.info(f"✅ Loaded {len(all_profiles)} profiles for training")
        return all_profiles
    ...
    def train_dnn_classifier(self, X, y):
        ...
        try:
            ...
            logger.info(f"✅ DNN trained - Accuracy: {accuracy:.4f}")
    ...
    def train_cnn_embedder(self, X, y):
        ...
        try:
            ...
            logger.info("✅ CNN trained and saved")
    ...
    def train_transformer_encoder(self, X, y):
        ...
        try:
            ...
            logger.info("✅ Transformer encoder trained and saved")
            return {'status': 'success'}
