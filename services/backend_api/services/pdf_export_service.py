"""
PDF Export Service for CareerTrojan Platform
...
Author: CareerTrojan Development Team
...
class PDFExportService:
    """PDF export service for CareerTrojan content"""
    ...
    def _setup_custom_styles(self):
        """Setup custom PDF styles for CareerTrojan branding"""
        
        # Title style
        self.styles.add(ParagraphStyle(
            name='CareerTrojanTitle',
    ...
    def _add_header_footer(self, canvas_obj, doc):
        ...
        canvas_obj.drawString(inch, self.page_height - 0.5*inch, "CareerTrojan")
        
        # Footer
        canvas_obj.setFont('Helvetica', 8)
        canvas_obj.setFillColor(colors.gray)
        footer_text = f"Generated by CareerTrojan on {datetime.now().strftime('%B %d, %Y')}"
    ...
    def create_professional_summary_pdf(
        ...
        # Title
        title = Paragraph("Professional Summary", self.styles['CareerTrojanTitle'])
        story.append(title)
        ...
        subtitle = Paragraph(subtitle_text, self.styles['CareerTrojanSubtitle'])
    ...
    def create_bullet_points_pdf(
        ...
        # Title
        title_para = Paragraph(title, self.styles['CareerTrojanTitle'])
        story.append(title_para)
        
        # Subtitle
        subtitle = Paragraph(user_name, self.styles['CareerTrojanSubtitle'])
        story.append(subtitle)
        ...
        for point in bullet_points:
            bullet = Paragraph(
                ...
                self.styles['CareerTrojanBullet']
            )
            story.append(bullet)
    ...
    def create_cover_letter_pdf(
        ...
        # Title
        title = Paragraph("Cover Letter", self.styles['CareerTrojanTitle'])
        story.append(title)
        ...
        subtitle = Paragraph(details, self.styles['CareerTrojanSubtitle'])
        story.append(subtitle)
    ...
    def create_job_description_pdf(
        ...
        # Title
        title = Paragraph(job_title, self.styles['CareerTrojanTitle'])
        story.append(title)
        
        # Company name
        if company_name:
            subtitle = Paragraph(company_name, self.styles['CareerTrojanSubtitle'])
            story.append(subtitle)
        ...
        # Job description
        if job_description:
            heading = Paragraph("Job Description", self.styles['CareerTrojanHeading'])
        ...
        # Responsibilities
        if responsibilities:
            heading = Paragraph("Key Responsibilities", self.styles['CareerTrojanHeading'])
            story.append(heading)
        ...
        # Requirements
        if requirements:
            heading = Paragraph("Requirements", self.styles['CareerTrojanHeading'])
            story.append(heading)
    ...
    def create_multi_content_pdf(
        self,
        contents: List[Dict],
        document_title: str = "CareerTrojan Generated Content"
    ) -> io.BytesIO:
        """
        ...
        # Main title
        title = Paragraph(document_title, self.styles['CareerTrojanTitle'])
        story.append(title)
        ...
        for i, content_data in enumerate(contents):
            ...
            # Section heading
            heading = Paragraph(section_title, self.styles['CareerTrojanHeading'])
            story.append(heading)
